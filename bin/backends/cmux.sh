...
# see fm_backend_cmux_bin) beyond the universal toolchain. Bootstrap detects it
# through fm_backend_required_tools only when cmux is resolved; this adapter
# also gates its CLI and universal jq before spawning.
