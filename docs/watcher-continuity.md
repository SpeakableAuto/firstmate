...
The native SDK mode in `tests/fm-pi-primary-live-e2e.test.sh` exercises Pi's actual input transform, consume, rejection, queue, and reload boundaries.
