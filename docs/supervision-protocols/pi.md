...
7. After an actionable child close, the extension rechecks session-lock ownership and verifies one successor before offering a batched follow-up hint; notification batching and bounded fallback are defined in `docs/watcher-continuity.md`.
